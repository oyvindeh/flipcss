var flipcss = {
     ...
     */
    _swapWords: function(string, word1, word2, flipFilenames) {
        // Regexp parts
        var rp = [];
...
module.exports = {
     ...
     */
    flip: function(string, warnings, flipPseudo, flipFilenames) {
        if (!warnings) {
            warnings = false;
        }
        if (!flipPseudo) {
        ...
        // Do processing
        string = flipcss._swapWords(string, "left", "right", flipFilenames);
