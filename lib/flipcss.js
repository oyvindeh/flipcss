var flipcss = {
     ...
     * @param {Boolean} flipFilenames
     * @returns {String} Processed string.
     */
    _swapWords: function(string, word1, word2, flipFilenames, flipSelectors) {
        // Regexp parts
        var rp = [];
    ...
    /**
     * Swap the :before and :after pseudo elements. If the "flipPseudo" argument
     ...
     * @private
     * @param {String} string String to process
     * @param {Boolean} flipPseudo Flip all occurences
     * @returns {String} Processed string
     */
    _swapBeforeAfter: function(string, flipPseudo) {
        var pattern;
...
module.exports = {
     ...
     * @param {Boolean} [flipPseudo=false] Flip :before and :after.
     * @param {Boolean} [flipFilenames=true] Flip filenames inside url().
     * @param {Boolean} [flipSelectors=true] Flip selectors
     * @returns {String} Flipped CSS.
     */
    flip: function(string, warnings, flipPseudo, flipFilenames, flipSelectors) {
        warnings = typeof warnings == "undefined" ? false : true;
        flipPseudo = typeof flipPseudo  == "undefined" ? false : true;
        flipFilenames = typeof flipFilenames == "undefined" ? true : false;
        flipSelectors = typeof flipSelectors == "undefined" ? true : false;
